...
// extern int sys_kthread_create(void* (*start_func)(), void* stack, int stack_size);
// extern int sys_kthread_id();
// extern void sys_kthread_exit();
// extern int sys_kthread_join(int thread_id);
// extern int sys_kthread_mutex_alloc();
// extern int sys_kthread_mutex_dealloc(int mutex_id);
// extern int sys_kthread_mutex_lock(int mutex_id);
// extern int sys_kthread_mutex_unlock(int mutex_id);
